"""siscadro-jxl: JXL job-file survey point parser and extractor adapter.

This package parses Leica/Trimble JXL job-file (``JOBFile``) XML
documents and exposes them through the same canonical
``siscadro-survey`` extraction, XLSX, and database APIs used by the
...
from siscadro_survey import extractors
...
from siscadro_jxl.parser import JxlParseError, JxlParser
