...
:class:`openroland_survey.extractors.SurveyPointExtractor` protocol,
translating the raw models produced by :mod:`openroland_jxl.parser` into the
canonical :class:`~openroland_survey.records.SurveyPointRecord` shape shared
...
:mod:`openroland_jxl.parser` and :mod:`openroland_jxl.models` stay usable on
