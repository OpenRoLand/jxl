...
:class:`openroland_survey.records.SurveyPointRecord` model. They are kept
public and independent from :mod:`openroland_jxl.extractor` so callers that
...
import attrs
from openroland_survey.records import ParseIssue
